...
public class AcceptanceTest extends TestCase{
    ...
    public void testRow117(){
        ...
        Fortune f = new Fortune("Sea Battle",2);
        p.setFortuneCard(f);
        String[] values = {"Sword","Monkey","Monkey","Gold","Parrot","Parrot","Monkey","Sword"};
        ArrayList<String> dice = new ArrayList<>(Arrays.asList(values));
        p.setPlayerDices(dice);
        int score = game.seaBattleScore(p);
        p.setScore(Math.max(p.getScore() + score, 0));
    ...
    public void testRow118(){
        ...
        Fortune f = new Fortune("Sea Battle",2);
        p.setFortuneCard(f);
        String[] values = {"Sword","Monkey","Monkey","Monkey","Skull","Skull","Monkey","Sword"};
        ArrayList<String> dice = new ArrayList<>(Arrays.asList(values));
        p.setPlayerDices(dice);
        int score = game.seaBattleScore(p);
        p.setScore(Math.max(p.getScore() + score, 0));
    ...
    public void testRow120(){
        ...
        Fortune f = new Fortune("Sea Battle",3);
        p.setFortuneCard(f);
        String[] values = {"Sword","Monkey","Monkey","Monkey","Skull","Sword","Sword","Sword"};
        ArrayList<String> dice = new ArrayList<>(Arrays.asList(values));
        p.setPlayerDices(dice);
        int score = game.seaBattleScore(p);
        p.setScore(Math.max(p.getScore() + score, 0));
    ...
    public void testRow121(){
        ...
        Fortune f = new Fortune("Sea Battle",3);
        p.setFortuneCard(f);
        String[] values = {"Sword","Skull","Skull","Sword","Skull","Skull","Sword","Sword"};
        ArrayList<String> dice = new ArrayList<>(Arrays.asList(values));
        p.setPlayerDices(dice);
        int score = game.seaBattleScore(p);
        assertEquals(-500,score);
    ...
    public void testRow124(){
        Player p = new Player(1);
        Fortune f = new Fortune("Sea Battle",4);
        p.setFortuneCard(f);
        String[] values = {"Sword","Sword","Parrot","Parrot","Skull","Sword","Sword","Diamond"};
        ArrayList<String> dice = new ArrayList<>(Arrays.asList(values));
        p.setPlayerDices(dice);
        int score = game.seaBattleScore(p);
        p.setScore(Math.max(p.getScore() + score, 0));
